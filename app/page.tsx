...
import { Head } from "next/head"; // Importiere den Head-Tag von Next.js
...
function MainContent() {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold mb-4">Embers-Helpdesk</h1>
...
export default function Home() {
  return (
    <HandbuchProvider>
      <Head>
        <title>Embers-Helpdesk</title> {/* Setze den Titel hier, falls nötig */}
        <meta name="description" content="Die zentrale Hilfeanwendung für Embers Helpdesk." />
      </Head>
      <MainContent />
      <Toaster />
    </HandbuchProvider>
